...
class PATH:
    def __init__(self):
        ...
        self.DATASET_PATH = '/data-ssd1/ouyangxc/mcan/datasets/vqa/'

        # bottom up features root path
        #self.FEATURE_PATH = './datasets/coco_extract/'
        self.FEATURE_PATH = '/data-ssd1/ouyangxc/mcan/datasets/cocn_extract/'
        self.PROBLEM_PATH = '/data-ssd1/ouyangxc/scienceQA/problems.json'
        self.PID_PATH= '/data-ssd1/ouyangxc/scienceQA/pid_splits.json'
        self.CAPTION_PATH= '/data-ssd1/ouyangxc/scienceQA/captions.json'
        self.LIST_PATH='/data-ssd1/ouyangxc/scienceQA/image_list.json'
        self.init_path()
